...
def main(data_dir):
    ...
    im_dir = os.path.join(data_dir, 'WIDER_train/images')
    ...
    f1 = open(os.path.join(data_dir, '12/pos_12.txt'), 'w')
    f2 = open(os.path.join(data_dir, '12/neg_12.txt'), 'w')
    f3 = open(os.path.join(data_dir, '12/part_12.txt'), 'w')
