...
import torch
import numpy as np
from model.mtcnn import PNet_Detect, RNet_Detect
...
def main(data_dir, pnet_path, rnet_path):
    ...
    f1 = open(os.path.join(data_dir, '48/pos_48.txt'), 'w')
    f2 = open(os.path.join(data_dir, '48/neg_48.txt'), 'w')
    f3 = open(os.path.join(data_dir, '48/part_48.txt'), 'w')
    ...
    for batch_idx, annotation in enumerate(annotations):
        ...
        _, boxes_align = rnet_detect(im_path, boxes_align)
...
if __name__ == '__main__':
    main('E:/TEST/MTCNN_DATA/', '../model/pnet.pth', '../model/rnet.pth')